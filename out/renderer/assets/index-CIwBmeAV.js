...
const BookUser = createLucideIcon("book-user", __iconNode$n);
/**
 * @license lucide-react v0.526.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Delete = createLucideIcon("delete", __iconNode$h);
/**
 * @license lucide-react v0.526.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const TreeDeciduous = createLucideIcon("tree-deciduous", __iconNode$6);
/**
 * @license lucide-react v0.526.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
var ThemePreset = /* @__PURE__ */ ((ThemePreset2) => {
  ThemePreset2["CALM_TECH"] = "calm-tech";
  ThemePreset2["SOFT_NEUMORPHISM"] = "soft-neumorphism";
  ThemePreset2["CUSTOM"] = "custom";
  return ThemePreset2;
})(ThemePreset || {});
...
function watchSystemColorScheme(callback) {
...
function generateThemeId(preset, mode) {
  return `${preset}-${mode}`;
}
function getThemeClassName(mode) {
  switch (mode) {
    case ThemeMode.DARK:
      return "dark";
...
function updateDocumentThemeClass(mode) {
  const root = document.documentElement;
...
function ThemeProvider({
  ...
  const [state, dispatch] = reactExports.useReducer(themeReducer, {
    ...defaultThemeState,
    mode: defaultMode,
    preset: defaultPreset
  });
  const loadFromStorage = reactExports.useCallback(() => {
    const savedMode = storage.get(`${storageKey}-mode`);
    const savedPreset = storage.get(`${storageKey}-preset`);
  ...
  const saveToStorage = reactExports.useCallback((mode, preset) => {
    storage.set(`${storageKey}-mode`, mode);
    storage.set(`${storageKey}-preset`, preset);
  }, [storageKey]);
  const applyTheme = reactExports.useCallback((theme, mode) => {
    const cssVariables = generateCSSVariables(theme.tokens);
    applyCSSVariables(cssVariables);
    updateDocumentThemeClass(
      mode === ThemeMode.SYSTEM ? state.systemPrefersDark ? ThemeMode.DARK : ThemeMode.LIGHT : mode
    );
  ...
  const exportThemeToCSS = reactExports.useCallback(() => {
    const cssVariables = generateCSSVariables(state.currentTheme.tokens);
    const cssContent = Object.entries(cssVariables).map(([property, value]) => `  ${property}: ${value};`).join("\n");
    return `:root {
${cssContent}
}`;
  ...
  reactExports.useEffect(() => {
    const effectiveMode = state.mode === ThemeMode.SYSTEM ? state.systemPrefersDark ? ThemeMode.DARK : ThemeMode.LIGHT : state.mode;
...
function useThemeVariables() {
  ...
  return reactExports.useMemo(() => {
    ...
    return {
      ...
      shadowExtruded: tokens.shadows.extruded ? `var(--shadow-extruded, ${tokens.shadows.extruded})` : void 0,
      shadowInset: tokens.shadows.inset ? `var(--shadow-inset, ${tokens.shadows.inset})` : void 0,
      // 动效
...
const Sidebar = ({ currentPage, onPageChange }) => {
  ...
  const mainNavItems = [
    { icon: House, text: "开始", id: "start" },
    { icon: ChartColumn, text: "仪表盘", id: "dashboard" },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold", children: "H" })
                }
              ),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: mainNavItems.map((item, index2) => {
                    const Icon2 = item.icon;
                    const isActive = currentPage === item.id;
                    const NavButton = /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "ghost",
                        size: "sm",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 18, className: "flex-shrink-0" }),
                          !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-3 whitespace-nowrap", children: item.text })
                        ]
                      },
                      index2
                    );
                    if (isCollapsed) {
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: NavButton }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.text }) })
                      ] }, index2);
                    }
                    return NavButton;
                  })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: (() => {
                    const SettingsButton = /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "ghost",
                        size: "sm",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 18, className: "flex-shrink-0" }),
                          !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-3 whitespace-nowrap", children: "设置" })
                        ]
                      }
                    );
                    if (isCollapsed) {
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: SettingsButton }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "设置" }) })
                      ] }, "settings");
                    }
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      className: cn$1("h-12 flex items-center justify-end px-6"),
      style: {
...
const MainLayout = ({ children, currentPage, onPageChange }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: cn$1("flex h-screen overflow-hidden m-0 p-0"),
      style: {
        backgroundColor: themeVars.backgroundPrimary,
        color: themeVars.textPrimary,
        transition: transition.colorTransition,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { currentPage, onPageChange }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "main",
            {
...
const Dashboard = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: { backgroundColor: themeVars.colorSuccess },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 6L5 9L10 3", stroke: "white", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) })
                      }
                    )
                  ] })
                ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-4 h-64", children: ["周一", "周二", "周三", "周四", "周五", "周六", "周日"].map((day, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-end", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "w-full rounded-t-lg mb-2 transition-all duration-300",
                    style: {
                      backgroundColor: index2 === 3 ? themeVars.accentPrimary : themeVars.backgroundInteractive,
...
const contextsWithChainsAtom = atom(null);
const contextsLoadingAtom = atom(false);
const contextsErrorAtom = atom(null);
const activeSessionAtom = atom(null);
const chainStatisticsAtom = atom(null);
const contextStatisticsAtom = atom([]);
const tagsAtom = atom([]);
const settingsAtom = atom(null);
atom((get) => {
...
atom((get) => {
  const contexts = get(contextsWithChainsAtom);
  if (!contexts) return 0;
  const activeChains = contexts.filter((ctx) => ctx.activeChain).map((ctx) => ctx.activeChain.counter);
...
const selectedContextIdAtom = atom(null);
const showCreateContextDialogAtom = atom(false);
const showChainManagementAtom = atom(false);
const currentPageAtom = atom("start");
atom({
  contexts: false,
  statistics: false,
  session: false,
...
function useCTDPActions() {
  ...
  const updateSacredContext = async (contextId, contextData) => {
    if (!ipcRenderer) return null;
    try {
  ...
  const deleteSacredContext = async (contextId) => {
  ...
  const startSession = async (contextId, taskInfo) => {
    if (!ipcRenderer) return null;
    try {
      ...
      if (context && result.chain) {
        const session = {
          ...
          expectedEndTime: taskInfo?.expectedDuration ? new Date(Date.now() + taskInfo.expectedDuration * 1e3) : void 0,
          taskTitle: taskInfo?.title,
          tags: []
          // 从taskInfo.tags获取完整Tag对象
        };
  ...
  const breakSession = async (reason, metadata) => {
    if (!ipcRenderer) return null;
    try {
      const chainId = "current-chain-id";
  ...
  const fulfillTask = async (auxiliaryId) => {
    if (!ipcRenderer) return false;
    try {
  ...
  const failTask = async (auxiliaryId) => {
    if (!ipcRenderer) return false;
    try {
...
const toast = {
  ...
  message: (message, options) => {
    return toast$1(message, options);
  }
};
var IconNames = /* @__PURE__ */ ((IconNames2) => {
  IconNames2["BRAIN_CIRCUIT"] = "BRAIN_CIRCUIT";
  IconNames2["BOOK_OPEN"] = "BOOK_OPEN";
  IconNames2["ZAP"] = "ZAP";
  IconNames2["WIND"] = "WIND";
  IconNames2["SPARKLES"] = "SPARKLES";
  IconNames2["WAND2"] = "WAND2";
  IconNames2["PLAY"] = "PLAY";
  IconNames2["CALENDAR"] = "CALENDAR";
  IconNames2["LIST"] = "LIST";
  IconNames2["PLUS"] = "PLUS";
  IconNames2["SETTINGS"] = "SETTINGS";
  IconNames2["TARGET"] = "TARGET";
  IconNames2["CLOCK"] = "CLOCK";
  IconNames2["CHECK_CIRCLE"] = "CHECK_CIRCLE";
  IconNames2["USERS"] = "USERS";
  IconNames2["HOME"] = "HOME";
  IconNames2["ACTIVITY"] = "ACTIVITY";
  return IconNames2;
})(IconNames || {});
const ICON_MAP = {
  // 核心功能图标
...
function getIconComponent(iconName) {
  ...
  return ICON_MAP[iconName] || ICON_MAP[
    "BRAIN_CIRCUIT"
    /* BRAIN_CIRCUIT */
  ];
}
const AVAILABLE_ICONS = [
  { name: "BRAIN_CIRCUIT", component: BrainCircuit, label: "深度工作" },
  { name: "BOOK_OPEN", component: BookOpen, label: "学习阅读" },
  { name: "ZAP", component: Zap, label: "活力充沛" },
  { name: "WIND", component: Wind, label: "冥想放松" },
  { name: "SPARKLES", component: Sparkles, label: "创意灵感" },
  { name: "WAND2", component: WandSparkles, label: "魔法专注" }
];
const COLOR_MAP = {
  [
    "INDIGO"
    /* INDIGO */
  ]: { name: "indigo", hex: "#6366F1", label: "靛蓝色" },
  [
    "BLUE"
    /* BLUE */
...
const AVAILABLE_COLORS = Object.values(COLOR_MAP);
function getColorHex(colorName) {
  ...
  return colorEntry?.hex || COLOR_MAP[
    "INDIGO"
    /* INDIGO */
  ].hex;
}
...
const CreateContextPage = ({ onBack, isEditing = false, contextId }) => {
  const themeVars = useThemeVariables();
  const { createSacredContext, updateSacredContext } = useCTDPActions();
  const contextsWithChains = useAtomValue(contextsWithChainsAtom);
  const [contextName, setContextName] = reactExports.useState("");
  const [contextDescription, setContextDescription] = reactExports.useState("");
  const [selectedIcon, setSelectedIcon] = reactExports.useState(AVAILABLE_ICONS[0].name);
  const [selectedColor, setSelectedColor] = reactExports.useState(AVAILABLE_COLORS[0].name);
  const [defaultDuration, setDefaultDuration] = reactExports.useState(45);
  const [rules, setRules] = reactExports.useState("");
  const [triggerAction, setTriggerAction] = reactExports.useState("");
  const [selectedPresetTime, setSelectedPresetTime] = reactExports.useState("15分钟");
    ...
    if (isEditing && contextId && contextsWithChains) {
      ...
      if (existingContext) {
        ...
        if (existingContext.rules) {
          try {
            const rulesData = typeof existingContext.rules === "string" ? JSON.parse(existingContext.rules) : existingContext.rules;
  ...
  const handleSubmit = async () => {
    ...
    try {
      const contextData = {
        ...
        description: contextDescription.trim() || void 0,
        icon: selectedIcon,
        color: getColorHex(selectedColor),
        rules: {
          items: rules.split("\n").filter((rule) => rule.trim()),
          defaultDuration,
          triggerAction: triggerAction.trim() || void 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center p-8 pb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onBack,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 20, style: { color: themeVars.textSecondary } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isEditing ? "修改你的神圣情境配置和规则。" : "配置你的神圣情境，定义专注的规则。"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-8 pt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-6 items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 text-3xl font-bold text-indigo-400", children: "1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs mt-1", style: { color: themeVars.textSecondary }, children: [
                      contextDescription.length,
                      "/200"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-8", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-2 mt-2", children: AVAILABLE_ICONS.map((icon) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          onClick: () => setSelectedIcon(icon.name),
                          className: "p-3 rounded-md transition-all border-2",
                          style: {
                            backgroundColor: selectedIcon === icon.name ? "#6366F1" : `${themeVars.backgroundSecondary}`,
                            borderColor: selectedIcon === icon.name ? "#818CF8" : "transparent"
                          },
                          title: icon.label,
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(icon.component, { size: 24, color: "white" })
                        },
                        icon.name
                      )) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-2 mt-2", children: AVAILABLE_COLORS.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-6 items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 text-3xl font-bold text-indigo-400", children: "2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "label",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "默认专注时长" })
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            style: { color: themeVars.textSecondary },
                            children: "设定单次专注任务的推荐时长。你可以在启动时随时修改。"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 mt-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              type: "range",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "label",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "行为准则" })
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            className: "text-xs mt-1",
                            style: { color: themeVars.textSecondary },
                            children: "定义进入此情境后需要遵守的规则。未来可在此处配置应用白名单。"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "textarea",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-6 items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 text-3xl font-bold text-indigo-400", children: "3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "h3",
                        {
                          ...
                          style: { color: themeVars.textPrimary },
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 18, className: "text-indigo-400" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "辅助链 (预约) 设置" })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          style: { color: themeVars.textSecondary },
                          children: '配置启动此情境的"预约信号"，用于克服启动困难。'
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "label",
                          {
                            className: "text-sm font-medium",
                            style: { color: themeVars.textSecondary },
                            children: "预约时长 (触发后多久内必须开始)"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-2 mt-2", children: presetTimes.map((time) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            onClick: () => setSelectedPresetTime(time),
                            className: "px-4 py-2 rounded-md transition font-medium",
                            style: {
                              backgroundColor: selectedPresetTime === time ? "#6366F1" : `${themeVars.backgroundSecondary}50`,
                              color: selectedPresetTime === time ? "white" : themeVars.textPrimary
                            },
                            children: time
                          },
                          time
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex justify-end space-x-4 max-w-3xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: onBack,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isSubmitting ? isEditing ? "保存中..." : "创建中..." : isEditing ? "保存修改" : "创建情境"
              }
            )
          ] })
        ] })
...
const ContextManagementPage = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin w-8 h-8 border-2 border-blue-500 border-t-transparent rounded-full mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "加载情境数据..." })
        ] })
      }
    );
  }
  const getRulesData = () => {
    ...
    try {
      const rulesData2 = typeof currentContext.rules === "string" ? JSON.parse(currentContext.rules) : currentContext.rules;
      return {
        defaultDuration: rulesData2.defaultDuration || 45,
        items: rulesData2.items || []
      };
    } catch (error) {
      console.error("解析规则数据失败:", error);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onBack,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { size: 20, color: "white" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  className: "text-xl font-bold",
                  style: { color: themeVars.textPrimary },
                  children: currentContext?.name || contextName
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-80 flex-shrink-0 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 space-y-1 text-sm", children: rulesData.items.length > 0 ? rulesData.items.map((rule, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: themeVars.textPrimary }, children: [
                        index2 + 1,
                        ". ",
                        rule
                      ] }, index2)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: themeVars.textSecondary }, children: "暂无行为准则" }) })
                    ] }),
                    currentContext?.description && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                        {
                          className: "text-sm font-medium",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: { color: themeVars.textPrimary },
                          children: currentContext.description
                        }
                      )
                    ] })
                  ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                currentContext?.activeChain ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            "链长: #",
                            currentContext.activeChain.counter
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            "创建于: ",
                            new Date(currentContext.activeChain.createdAt).toLocaleDateString("zh-CN")
                          ]
                        }
                      )
                    ]
                  ...
                  "div",
                  {
                    ...
                    style: { color: themeVars.textSecondary },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "暂无活跃的链记录" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", children: "开始一个专注会话来创建新的链" })
                    ]
                  }
                )
              ]
...
const StartPage = () => {
  ...
  const [selectedContext, setSelectedContext] = reactExports.useState(null);
  const { startSession, initializeData } = useCTDPActions();
  ...
  const handleStartSession = async (contextId, contextName) => {
    try {
  ...
  const calculateSuccessRate = (context) => {
    if (!context.activeChain) return 0;
    const successLogs = context.activeChain.logs?.filter((log) => log.type === "SUCCESS") || [];
    const totalLogs = context.activeChain.logs?.length || 0;
    if (totalLogs === 0) return 0;
    return Math.round(successLogs.length / totalLogs * 100);
  };
  const formatLastActivity = (context) => {
    if (!context.activeChain?.logs?.length) return "从未";
    const lastLog = context.activeChain.logs[0];
    const date = new Date(lastLog.createdAt);
    const now = /* @__PURE__ */ new Date();
    const diffHours = Math.floor((now.getTime() - date.getTime()) / (1e3 * 60 * 60));
  ...
  if (currentView === "create") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CreateContextPage, { onBack: () => setCurrentView("main") });
  }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-2", children: "加载失败" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-4", style: { color: themeVars.textSecondary }, children: error }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-8 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto overflow-x-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-6 pb-8 justify-start", children: contexts?.map((context) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 p-4 pb-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 px-4 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: context.description || "暂无描述"
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 px-4 flex flex-col justify-center min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 p-4 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      onClick: (e) => {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 16 })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "管理你的习惯，构建稳固的生活基石。"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: rsipItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: item.id === 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { size: 20, color: item.isActive ? "white" : themeVars.textSecondary }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { size: 20, color: item.isActive ? "white" : themeVars.textSecondary })
                }
              ),
...
function App() {
  const [currentPage, setCurrentPage] = reactExports.useState("start");
  const renderCurrentPage = () => {
    switch (currentPage) {
      case "start":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(StartPage, {});
      case "dashboard":
      ...
      // 暂时使用Dashboard
      case "rsip-tree":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(RSIPTreePage, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(StartPage, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { currentPage, onPageChange: setCurrentPage, children: renderCurrentPage() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemedToaster, {})
  ] });
}
